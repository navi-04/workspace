const eventData = [
  ...
  {
    level: 2,
    topic: "Web API Integration",
    description: "Explore how to fetch data from external APIs and integrate it into your web applications.",
    link: "https://example.com/api-integration",
    prompt: "Create a weather app that fetches data from a public weather API."
  },
  {
    level: 3,
